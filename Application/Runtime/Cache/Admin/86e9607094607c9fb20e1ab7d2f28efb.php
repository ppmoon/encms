...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="col-md-9">
	<form action="<?php echo U('Admin/Blog/doEdit');?>" enctype="multipart/form-data" method="post">
    <table class="table">
      <tr>
        <th colspan="2">修改音频</th>
      </tr>
      <tr>
	  <tr>
		<td>
			<td><input type="hidden" name="id" value="<?php echo ($itemId); ?>" /></td>
		</td>
	  </tr>
        <td align="right" width="10%">选择音频分类</td>
        <td>
          <select name="cid">
						<option value="">===请重新选择分类===</option>
      ...
      <tr>
        <td align="right">音频标题</td>
        <td>
          <input type="text" name="title" value="<?php echo ($itemName); ?>"/>
        </td>
      </tr>
      <tr>
